...
try {
    ...
    echo '<script>alert("Something goes wrong. Please, ensure that you\'ve added the database credentials correctly!")</script>';
    die();
}
?>
<!DOCTYPE html>
...
<body id="feedback-default">

<nav>
    <div class="container">
        <div class="nav-wrapper">
            <a href="index.php" class="brand-logo"><img src="admin/asset/images/logo-transparent.png"
                                                                 alt="Royal Testimonial"></a>
            <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <li class="active"><a href="index.php">View Testimonials</a></li>
                <li><a href="submit.php">Submit Testimonial</a></li>
            </ul>
            <ul class="side-nav" id="mobile-demo">
                <li class="active"><a href="index.php">View Testimonials</a></li>
                <li><a href="submit.php">Submit Testimonials</a></li>
            </ul>
        </div>
    </div>
</nav>
