    ...
    <div class="container">
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="feedback-basic.php">View Testimonials</a></li>
                <li class="active"><a href="submit-basic.php">Submit Testimonial</a></li>
            </ul>
            <ul class="side-nav" id="mobile-demo">
                <li><a href="feedback-basic.php">View Testimonials</a></li>
                <li class="active"><a href="submit-basic.php">Submit Testimonials</a></li>
            </ul>
        </div>
    </div>
</nav>
