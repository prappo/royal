...
<html lang="en">
<head>
    <title>Testimonial Grid Style | Royal Testimonial</title>
...
<body id="feedback-grid">

<nav>
    <div class="container">
        <div class="nav-wrapper">
            <a href="feedback-grid.php" class="brand-logo"><img src="admin/asset/images/logo-transparent.png"
                                                                alt="Royal Testimonial"></a>
            <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <li class="active"><a href="feedback-grid.php">View Testimonials</a></li>
                <li><a href="submit-grid.php">Submit Testimonial</a></li>
            </ul>
            <ul class="side-nav" id="mobile-demo">
                <li class="active"><a href="feedback-grid.php">View Testimonials</a></li>
                <li><a href="submit-grid.php">Submit Testimonials</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<main>
    <div class="container">
        ...
        $show->getGridStyle('admin/asset/images/');
        ?>
