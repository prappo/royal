...
<html lang="en">
<head>
    <title>Submit Testimonial | Royal Testimonial</title>
...
<body id="feedback-submit">

<nav>
    <div class="container">
        <div class="nav-wrapper">
            <a href="feedback-carousel.php" class="brand-logo"><img src="admin/asset/images/logo-transparent.png"
                                                                alt="Royal Testimonial"></a>
            <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <li><a href="feedback-carousel.php">View Testimonials</a></li>
                <li class="active"><a href="submit-carousel.php">Submit Testimonial</a></li>
            </ul>
            <ul class="side-nav" id="mobile-demo">
                <li><a href="feedback-carousel.php">View Testimonials</a></li>
                <li class="active"><a href="submit-carousel.php">Submit Testimonials</a></li>
            </ul>
        </div>
    </div>
</nav>
