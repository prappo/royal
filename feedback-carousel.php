...
<html lang="en">
<head>
    <title>Testimonial Carousel Style | Royal Testimonial</title>
    ...
    <div class="container">
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                <li class="active"><a href="feedback-carousel.php">View Testimonials</a></li>
                <li><a href="submit-carousel.php">Submit Testimonial</a></li>
            </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                $show->getCarouselStyle('admin/asset/images/');
                ?>
            </div>
        </div>
    </div>
